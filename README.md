![image](https://github.com/ali-obaid1994/Walmart_Sales_Analysis/assets/148888861/49513ab4-2536-49b5-8f7c-42c6e4b28d64)
...
"In this recruiting competition, job-seekers are provided with historical sales data of Walmart stores located in different regions. Each store contains many departments and participants must project the sales for each department in each store. To add to the challenge, selected holiday markdown events are included in the dataset. These markdowns are known to affect sales, but it is challenging to predict which departments are affected and the extent of the impact." [source](https://www.kaggle.com/c/walmart-recruiting-store-sales-forecasting)
...
4. Which gender has most of the customers?
5. How much distribution gender did per branch?
