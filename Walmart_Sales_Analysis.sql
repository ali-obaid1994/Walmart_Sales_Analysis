...
SELECT payment, COUNT(*) AS payment_count FROM sales GROUP BY payment ORDER BY payment_count DESC limit 1;
...
#6. Which time of the day customers give most ratings?
...
#7. Which time of the day customers give most ratings per branch?
